        ...
        <el-dialog title="添加" :visible.sync="showAdd" @closed="closed()" @open="queryUser()">
            <div>
                <el-form ref="forms" :model="form" :rules="rules" label-width="90px" class="form">
                    <el-form-item label="订单号" label-width="90px" prop="boxId">
                        <el-input placeholder="请输入订单号" v-model="form.boxId"></el-input>
                    </el-form-item>
                    <el-form-item label="用户Id" label-width="90px" prop="userId">
                    ...
                    <el-form-item label="礼物Id" label-width="90px" prop="boxId">
                        <el-input placeholder="请输入礼物Id" v-model="form.boxId"></el-input>
                    </el-form-item>
                    <el-form-item label="收礼用户Id" label-width="90px" prop="boxId">
                        <el-input placeholder="请输入收礼用户Id" v-model="form.boxId"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="礼物价值" label-width="90px" prop="price">
                        <el-input placeholder="请输入礼物价值" v-model="form.price"></el-input>
                    </el-form-item>
...
export default {
    data() {
        return {
            ...
            rules: {
                ...
                otherId: [{ required: true, message: "请输入三方订单号", trigger: "blur" }],
                userId: [
                    { required: true, message: "请选择用户", trigger: "change" },
                ],
                giftId: [
                    { required: true, message: "请输入礼物产品", trigger: "blur" },
                ],
                num: [
    ...
    methods: {
        ...
        queryData() {
            axios({
                method: "POST",
                url: "/api/zGiftsOrder/queryGiftOrder",
                headers: {
        ...
        deleteItem(idList) {
            this.$confirm("此操作将永久删除文件, 是否继续?", "提示", {
                ...
                this.post("/zGiftsOrder/deleteGiftOrder", {
                    idList: idList,
                }).then((res) => {
                    this.queryData();
                    this.$message({
